...
void state_advance()		/* alternate between toggling red & green */
{
  ...
  switch(state){
  case 0: red_on = 0; green_on = 0; state++; break;//both lights off
  case 1: red_on = 1; green_on = 0; state++; break;//red on
  case 2: red_on = 0; green_on = 1; state++; break;//green on
  case 3: red_on = 1; green_on = 1; state++; break;// both on
  default: state = 0;
  }
